...
// Your code here:
const  developerName =developers.map((developer)=>{
...
// Your code here:
const reactDevelopers = developers.filter((developer)=>{
  return developer.role ==="React";
});
console.log(reactDevelopers);
...
// Your code here:/
const inactiveDeveloper =developers.find((dev)=> dev.active === false);
const inactiveIndex =developers.findIndex((dev)=> dev.active === false);
console.log(inactiveDeveloper);
console.log("Index",inactiveIndex);
...
// Your code here:
const activeDeveloperNames = developers
.filter((dev) => dev.active === true)
.map((dev) => dev.name);
...
// Your code here:
const updateDevList= developers.map((dev) => {
  if(dev.id ===2){
    return {...dev, active:true};
  }
  return dev;
});
console.log(updateDevList);
